...
-- Note: Railway already created the database, so we skip CREATE DATABASE
-- Just create the tables and insert data

-- DROP tables if they exist (CAUTION: deletes data)
